    ...
    public static class SWF_Effects_To_Nitro
    {
        ...
        private static async Task<bool> ProcessSwfFileAsync(string swfFile)
        {
            ...
            if (EffectsMapping.Count == 0)
            {
                ...
                // Continue to generate JSON/Nitro without a spritesheet.
            }
            ...
            // If no valid images, we'll omit the spritesheet.
            ...
            {
                Console.WriteLine($"⚠️ No valid images found for {fileName}. Spritesheet will be omitted, but JSON and Nitro will be generated.");
            }
        ...
        private static async Task<(string LibraryName, Dictionary<string, EffectAssetsMapper.Asset> Assets)> GetAssetDataAsync(
            string binaryOutputPath, Dictionary<string, string> imageSources, string csvPath, string fileOutputDirectory)
        {
            ...
            if (manifestFiles.Length == 0)
            {
                ...
                return ("", new Dictionary<string, EffectAssetsMapper.Asset>());
            }
