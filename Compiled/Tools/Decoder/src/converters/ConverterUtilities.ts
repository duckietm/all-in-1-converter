...
{
    private static BUNDLE_TYPES: string[] = [ 'pet' ];
    private static DOWNLOAD_SWF_TYPES: string[] = [ 'pet' ];
    ...
    public async downloadSwfTypes(): Promise<void>
    {
        ...
        for(const downloadType of ConverterUtilities.DOWNLOAD_SWF_TYPES)
        {
            ...
            const saveDirectory = await FileUtilities.getDirectory(`../../SWFCompiler/pets`);
